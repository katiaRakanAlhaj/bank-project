...
const FirstModelCard = ({ pageData }) => {
  // Assuming pageData is structured as per the API response provided
  const { page } = pageData;
    ...
    <div>
      ...
      <div className="flex items-center text-center gap-x-2">
        ...
        <p className="text-[1.8rem] font-[700] text-[#333333]">
          {page.banner_title || "Default Title"} {/* Fallback title if empty */}
        </p>
      </div>
